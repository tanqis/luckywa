...
export default {
  ...
  methods: {
    test() {
      ...
      const CANVAS_WIDTH = document.getElementById('graph').scrollWidth;
      const CANVAS_HEIGHT = document.getElementById('graph').scrollHeight;
    ...
    createGraph() {
      ...
      const graph = new G6.Graph({
        container: 'graph', // String | HTMLElement，必须，在 Step 1 中创建的容器 id 或容器本身
